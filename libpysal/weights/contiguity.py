...
from .raster import da_checker, da2W, da2WSP
    ...
    **kw        : keyword arguments
    ...
    def from_dataframe(cls,
        ...
        if id_order is not None:
            if id_order is True and ((idVariable is not None) or
                                     (ids is not None)):
        ...
        return cls.from_iterable(df[geom_col].tolist(),
                                 ids=ids,
                                 id_order=id_order,
                                 **kwargs)
