...
class Testraster(unittest.TestCase):
    ...
    def test_da2W(self):
        ...
        self.assertEqual(
            w1[(1, -30.0, -180.0)], {(1, -90.0, 60.0): 1, (1, -90.0, -60.0): 1}
        )
        self.assertEqual(
            w1[(1, -30.0, 180.0)], {(1, -90.0, -60.0): 1, (1, -90.0, 60.0): 1}
        )
        ...
        self.assertEqual(
            sorted(w2.neighbors[(1, -90.0, 180.0)]),
            [(1, -90.0, 60.0), (1, -30.0, 180.0)],
        )
        self.assertEqual(
            sorted(w2.neighbors[(1, -90.0, 60.0)]),
            [(1, -90.0, -60.0), (1, -90.0, 180.0), (1, -30.0, 60.0)],
        )
        ...
        self.assertEqual(
            sorted(w3.neighbors[(1, -90.0, 180.0)]),
            [(1, -90.0, 60.0), (1, -30.0, 60.0), (1, -30.0, 180.0)],
        )
