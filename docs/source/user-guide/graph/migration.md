...
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------- |
| cardinalities    | [`builtins.dict`](#libpysal.weights.W.cardinalities)         | [`pandas.Series`](#libpysal.graph.Graph.cardinalities)        |
| component_labels | [`numpy.ndarray`](#libpysal.weights.W.component_labels)      | [`pandas.Series`](#libpysal.graph.Graph.component_labels)     |
| nonzero          | [`builtins.int`](#libpysal.weights.W.nonzero)                | [`numpy.int64`](#libpysal.graph.Graph.nonzero)                |
| sparse           | [`scipy.sparse._csr.csr_matrix`](#libpysal.weights.W.sparse) | [`scipy.sparse._csr.csr_array`](#libpysal.graph.Graph.sparse) |
| transform        | [`builtins.str`](#libpysal.weights.W.transform)              | [`builtins.method`](#libpysal.graph.Graph.transform)          |
...
| Member                                                                     |   Type          |
| -------------------------------------------------------------------------- | --------------- |
| [`adjacency`](#libpysal.graph.Graph.adjacency)                             | pandas.Series   |
| [`aggregate`](#libpysal.graph.Graph.aggregate)                             | builtins.method |
| [`apply`](#libpysal.graph.Graph.apply)                                     | builtins.method |
| [`assign_self_weight`](#libpysal.graph.Graph.assign_self_weight)           | builtins.method |
| [`build_block_contiguity`](#libpysal.graph.Graph.build_block_contiguity)   | builtins.method |
| [`build_contiguity`](#libpysal.graph.Graph.build_contiguity)               | builtins.method |
| [`build_distance_band`](#libpysal.graph.Graph.build_distance_band)         | builtins.method |
| [`build_fuzzy_contiguity`](#libpysal.graph.Graph.build_fuzzy_contiguity)   | builtins.method |
| [`build_h3`](#libpysal.graph.Graph.build_h3)                               | builtins.method |
| [`build_kernel`](#libpysal.graph.Graph.build_kernel)                       | builtins.method |
| [`build_knn`](#libpysal.graph.Graph.build_knn)                             | builtins.method |
| [`build_raster_contiguity`](#libpysal.graph.Graph.build_raster_contiguity) | builtins.method |
| [`build_spatial_matches`](#libpysal.graph.Graph.build_spatial_matches)     | builtins.method |
| [`build_travel_cost`](#libpysal.graph.Graph.build_travel_cost)             | builtins.method |
| [`build_triangulation`](#libpysal.graph.Graph.build_triangulation)         | builtins.method |
| [`copy`](#libpysal.graph.Graph.copy)                                       | builtins.method |
| [`describe`](#libpysal.graph.Graph.describe)                               | builtins.method |
| [`difference`](#libpysal.graph.Graph.difference)                           | builtins.method |
| [`eliminate_zeros`](#libpysal.graph.Graph.eliminate_zeros)                 | builtins.method |
| [`equals`](#libpysal.graph.Graph.equals)                                   | builtins.method |
| [`explore`](#libpysal.graph.Graph.explore)                                 | builtins.method |
...
| [`higher_order`](#libpysal.graph.Graph.higher_order)                       | builtins.method |
| [`index_pairs`](#libpysal.graph.Graph.index_pairs)                         | builtins.tuple  |
| [`intersection`](#libpysal.graph.Graph.intersection)                       | builtins.method |
| [`intersects`](#libpysal.graph.Graph.intersects)                           | builtins.method |
| [`isolates`](#libpysal.graph.Graph.isolates)                               | pandas.Index    |
...
| [`summary`](#libpysal.graph.Graph.summary)                                 | builtins.method |
| [`symmetric_difference`](#libpysal.graph.Graph.symmetric_difference)       | builtins.method |
| [`to_W`](#libpysal.graph.Graph.to_W)                                       | builtins.method |
| [`to_gal`](#libpysal.graph.Graph.to_gal)                                   | builtins.method |
| [`to_gwt`](#libpysal.graph.Graph.to_gwt)                                   | builtins.method |
| [`to_parquet`](#libpysal.graph.Graph.to_parquet)                           | builtins.method |
| [`transformation`](#libpysal.graph.Graph.transformation)                   | builtins.str    |
| [`union`](#libpysal.graph.Graph.union)                                     | builtins.method |
| [`unique_ids`](#libpysal.graph.Graph.unique_ids)                           | pandas.Index    |